    ...
    <div class="ms-5 ms-lg-0 pt-lg-2">
        <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="?module=member" class="text-dark text-decoration-none">Pegawai</a>
                </li>
...
<div class="mb-5">
    <div class="d-grid gap-3 d-sm-flex flex-sm-row-reverse">
        <div class="d-grid gap-3 d-sm-flex">
            <!-- button ubah data -->
           <a href="?module=form_ubah_member&id=<?php echo $data['id_member']; ?>" 
   class="btn btn-outline-success rounded-pill d-flex align-items-center justify-content-center px-4">
...
<div class="bg-white rounded-4 shadow-sm p-4 mb-4">
    ...
    <div class="alert alert-secondary rounded-4 mb-5" role="alert">
        <i class="fas fa-user-check me-2"></i> Detail Data Pegawai
    </div>
    <!-- tampilkan data -->
    <div class="d-flex flex-column flex-xl-row">
        <div class="flex-shrink-0 text-center mb-5 mb-xl-0">
            <div class="foto-profil-detail">
                <img src="images/<?php echo $data['foto_profil']; ?>" alt="Foto Profil" class="img-fluid rounded-circle" style="width:200px; height:250px; object-fit:cover;">
            </div>
        </div>
