...
<div class="bg-white rounded-4 shadow-sm p-4 mb-4">
    ...
    <div class="alert alert-secondary rounded-4 mb-5" role="alert">
        <i class="fas fa-user-plus me-2"></i> Entri Data Pegawai Perhutani
    </div>
    <!-- form entri data -->
    <form action="modules/member/proses_simpan.php" method="post" enctype="multipart/form-data" class="needs-validation" novalidate>
        ...
        <div class="pt-4 pb-2 mt-5 border-top">
            <div class="d-grid gap-3 d-sm-flex justify-content-md-start pt-1">
                <!-- button simpan data -->
               <input type="submit" name="simpan" value="Simpan" class="btn btn-outline-success px-4" style="border-radius: 50px;">
