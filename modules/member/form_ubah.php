    ...
    <div class="ms-5 ms-lg-0 pt-lg-2">
        <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="?module=member" class="text-dark text-decoration-none">Data Pegawai</a>
                </li>
...
<div class="bg-white rounded-4 shadow-sm p-4 mb-4">
    ...
    <div class="alert alert-secondary rounded-4 mb-5" role="alert">
        <i class="fas fa-user-edit me-2"></i> Ubah Data Jabatan
    </div>
    <!-- form ubah data -->
    <form action="modules/member/proses_ubah.php" method="post" enctype="multipart/form-data" class="needs-validation" novalidate>
        <div class="row">
            ...
            <div class="col-xl-6">
                <div class="mb-3 ps-xl-3">
                    ...
                    <select name="jabatan" class="form-select" autocomplete="off" required>
                        <option value="<?php echo $data['jabatan']; ?>"><?php echo $data['jabatan']; ?></option>
                        <option disabled value="">-- Pilih --</option>
                        <option value="Administratur">Administratur</option>
                        <option value="Wakil Administratur">Wakil Administratur</option>
                        <option value="Kepala Seksi">Kepala Saksi</option>
                         <option value="Kepala Sub Seksi">Kepala Sub Saksi</option>
        ...
        <div class="pt-4 pb-2 mt-5 border-top">
            <div class="d-grid gap-3 d-sm-flex justify-content-md-start pt-1">
                <!-- button simpan data -->
                <input type="submit" name="simpan" value="Simpan" class="btn btn-outline-success rounded-pill px-4">
