    ...
    <div class="ms-5 ms-lg-0 pt-lg-2">
        <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="?module=member" class="text-dark text-decoration-none">Pegawai</a></li>
...
<div class="mb-5">
    ...
    <a href="?module=form_entri_member"
       class="btn btn-outline-success float-lg-end px-4 mb-4 mb-lg-0"
       style="border-radius: 100px;">
        <i class="fas fa-user-plus me-2"></i> Entri Pegawai
    </a>
</div>
        ...
        <div class="col-lg-7 col-xl-9">
            <form action="?module=tampil_pencarian_member" method="post" class="form-search needs-validation" novalidate>
                ...
                <div class="invalid-feedback">Masukan ID atau Nama Pegawai yang ingin Anda cari.</div>
            </form>
        </div>
    </div>
</div>
...
if (isset($_GET['pesan'])) {
    ...
    if ($_GET['pesan'] == 1) {
        ...
        echo '<div class="alert alert-success alert-dismissible rounded-4 fade show mb-4" role="alert">
                <strong><i class="fas fa-check-circle me-2"></i>Sukses!</strong> Data pegawai berhasil disimpan.
    ...
    elseif ($_GET['pesan'] == 2) {
        ...
        echo '<div class="alert alert-success alert-dismissible rounded-4 fade show mb-4" role="alert">
                <strong><i class="fas fa-check-circle me-2"></i>Sukses!</strong> Data pegawai berhasil dihapus.
                <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
            </div>';
    }
}
...
<div class="row">
    ...
    */
    ...
    $query = mysqli_query($mysqli, "SELECT id_member, jabatan, nama_lengkap, foto_profil FROM tbl_member 
            ...
            <div class="col-lg-6 col-xl-3">
                <div class="bg-white rounded-4 shadow-sm text-center p-4 p-lg-4-2 mb-4">
                    <div class="foto-profil mb-4">
                        <img src="images/<?php echo $data['foto_profil']; ?>" alt="Foto Profil" class="img-fluid rounded-circle"  style="width:130px; height:130px; object-fit:cover;">
                    </div>
                    <h6><?php echo $data['nama_lengkap']; ?></h6>
                    <p class="text-muted mb-4"><?php echo $data['jabatan']; ?></p>
                    <!-- button detail data -->
                  <a href="?module=tampil_detail_member&id=<?php echo $data['id_member']; ?>"
   ...
   style="border-radius: 50px;">
    ...
    <a class="btn btn-outline-success rounded-pill mx-1"
       href="?module=member&paginasi=<?php echo $x; ?>"
       style="padding: 7px 15px; font-size: 12px;">
        <?php echo $x; ?>
    </a>
</li>
