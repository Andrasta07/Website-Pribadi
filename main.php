...
<head>
    ...
    <!-- Title -->
    <title>Aplikasi Pengelolaan Data Pegawai </title>

    <!-- Favicon icon -->
    <link rel="shortcut icon" href="assets/img/logo-perhutani-01.png" type="image/x-icon">
...
<body>
    ...
    <section class="sidebar-menu d-none d-md-block shadow-sm">
        ...
        <div class="brand text-center mb-5">
            <!-- Logo -->
            <img src="assets/img/logo-perhutani-01.png" alt="Logo">
            <!-- Title -->
            <h3 class="mt-4 mb-3"> KPH BOJONEGORO </h3>
        </div>
        <div class="menus">
